...
import UnRevealedCard from '../TwoEventCardsModal/UnRevealedCard/UnRevealedCard';
...
function TwoEventCardsModal(props) {
  ...
  function confirmHandler() {
    ...
    const { forcedPlayer } = props;
    props.sendGameAction('force another player to choose card', {
      forcedPlayer,
      eventCardsIndexes,
    });
    setShowDetails(true);
